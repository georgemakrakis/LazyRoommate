...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Auth._MobileServices.AndroidAccountStore+SecretAccount, Microsoft.Azure.Mobile.Client, Version=4.0.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", AndroidAccountStore_SecretAccount.class, __md_methods);
	}
	...
	public AndroidAccountStore_SecretAccount () throws java.lang.Throwable
	{
		...
		if (getClass () == AndroidAccountStore_SecretAccount.class)
			mono.android.TypeManager.Activate ("Xamarin.Auth._MobileServices.AndroidAccountStore+SecretAccount, Microsoft.Azure.Mobile.Client, Version=4.0.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", "", this, new java.lang.Object[] {  });
	}
